...
function IconChart() {
  return (
    <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
      <rect x="6" y="22" width="7" height="12" rx="2" fill="currentColor" opacity="0.6" />
      <rect x="16" y="14" width="7" height="20" rx="2" fill="currentColor" />
      <rect x="26" y="8" width="7" height="26" rx="2" fill="currentColor" opacity="0.8" />
      <polyline points="9,20 19,12 29,6" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.9" />
    </svg>
  );
}
...
function IconBasket() {
  return (
    <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
      ...
      <path d="M14 16l4-8M26 16l-4-8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
...
function IconStore() {
  return (
    <svg viewBox="0 0 40 40" fill="none" className="w-full h-full">
      <rect x="6" y="18" width="28" height="16" rx="1" fill="currentColor" opacity="0.6" />
      <path d="M4 18l4-8h24l4 8" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
      <rect x="15" y="24" width="10" height="10" rx="1" fill="white" opacity="0.9" />
...
function CheckIcon() {
  return (
    <svg viewBox="0 0 22 22" fill="none" className="w-5 h-5 shrink-0 mt-0.5">
      ...
      <polyline points="6,11 9.5,14.5 16,8" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function ZaloIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
      ...
      <text x="2" y="17" fontSize="14" fontWeight="700" fill="currentColor" fontFamily="sans-serif">Za</text>
    </svg>
  );
}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <button onClick={() => handleNav("hero")} className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow overflow-hidden shrink-0">
            <img src={logoImg} alt="Tín Chấp Việt" className="w-9 h-9 object-contain" />
          </div>
          <div className="text-left">
            <div className="text-white font-bold text-sm leading-tight tracking-wide">TÍN CHẤP VIỆT</div>
            <div className="text-[#a8d5b5] text-[10px] tracking-widest uppercase">Vay tín chấp</div>
          </div>
        </button>
  ...
  return (
    <section id="hero" className="relative bg-[#e8f5ed] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#c8e6d0]/60" style={{ clipPath: "polygon(30% 0, 100% 0, 100% 100%, 0% 100%)" }} />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="animate-fadeup">
          <div className="inline-flex items-center gap-2 bg-[#c81f1a]/10 border border-[#c81f1a]/30 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-[#c81f1a] text-sm font-medium">Hỗ trợ doanh nghiệp 24/7</span>
          </div>
          ...
          <p className="text-[#2d6e47] text-base sm:text-lg mb-8 leading-relaxed max-w-md">
            Hỗ trợ khoản vay cho các hộ kinh doanh, doanh nghiệp nhỏ và vừa với thủ tục đơn giản, nhanh chóng.
          </p>

          {/* Loan range */}
          <div className="bg-[#c81f1a] rounded-2xl px-6 py-4 inline-block mb-8 shadow-[0_8px_32px_rgba(200,31,26,0.4)]">
            <div className="text-white/80 text-sm font-medium mb-0.5">Hạn mức khoản vay</div>
            <div className="text-white text-3xl sm:text-4xl font-black tracking-tight">50 Triệu – 1 Tỷ VNĐ</div>
          </div>
...
function Requirements() {
  const docs = [
    { title: "Căn Cước Công Dân", desc: "CCCD / CMND còn hiệu lực", icon: "🪪" },
    { title: "Giấy Phép Kinh Doanh", desc: "Đăng ký kinh doanh hợp lệ", icon: "📋" },
    ...
    <section id="requirements" className="bg-[#f5faf6] py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-[#0d3320]">Hồ Sơ Cần Chuẩn Bị</h2>
          <p className="text-gray-500 mt-3 max-w-md mx-auto">Chỉ cần vài giấy tờ cơ bản, hồ sơ được duyệt trong ngày</p>
        </div>

        <div className="grid sm:grid-cols-3 gap-6">
          {docs.map((d) => (
            <div key={d.title} className="bg-white rounded-2xl p-6 border border-[#e0f0e7] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200">
              <div className="text-4xl mb-4">{d.icon}</div>
              <div className="flex items-start gap-2 mb-2">
                <CheckIcon />
                <h3 className="font-bold text-[#0d3320] text-base leading-tight">{d.title}</h3>
              </div>
        ...
        <div className="mt-12 bg-[#0d3320] rounded-2xl p-6 sm:p-8">
          <h3 className="text-white font-bold text-lg mb-6 text-center">Quy trình 3 bước đơn giản</h3>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { step: "01", title: "Liên hệ tư vấn", desc: "Gọi hotline hoặc nhắn Zalo để được tư vấn miễn phí" },
              { step: "02", title: "Nộp hồ sơ", desc: "Chuẩn bị hồ sơ theo hướng dẫn, nộp trực tiếp hoặc online" },
              { step: "03", title: "Giải ngân", desc: "Hồ sơ duyệt trong ngày, tiền về tài khoản nhanh chóng" },
            ].map((s, i) => (
              <div key={s.step} className="relative flex flex-col items-center text-center">
                ...
                <p className="text-[#a8d5b5] text-xs leading-relaxed">{s.desc}</p>
              </div>
            ))}
          </div>
        </div>
    ...
    <section id="benefits" className="bg-white py-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-[#0d3320]">Vốn Đúng Lúc – Bứt Phá Doanh Thu</h2>
          <p className="text-gray-500 mt-3 max-w-lg mx-auto">Chúng tôi đồng hành cùng hàng ngàn hộ kinh doanh, cửa hàng, doanh nghiệp vừa và nhỏ trên khắp cả nước</p>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {items.map((item) => (
            ...
            >
              ...
              <h3 className="font-black text-[#0d3320] group-hover:text-white text-lg mb-3 transition-colors duration-300">{item.title}</h3>
              <p className="text-gray-500 group-hover:text-[#a8d5b5] text-sm leading-relaxed transition-colors duration-300">{item.desc}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className="bg-[#0d3320] rounded-2xl p-5 text-center">
              <div className="text-[#c81f1a] font-black text-2xl sm:text-3xl mb-1">{s.value}</div>
              <div className="text-[#a8d5b5] text-xs font-medium">{s.label}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <p className="text-[#a8d5b5] mb-8 leading-relaxed">
            Đội ngũ chuyên viên tư vấn sẵn sàng hỗ trợ bạn 24/7. Liên hệ ngay để được tư vấn miễn phí và giải ngân nhanh nhất.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 bg-[#1a5c35]/40 border border-[#256b40]/40 rounded-xl p-4">
              ...
              <div>
                <div className="text-[#a8d5b5] text-xs mb-0.5">Hotline tư vấn</div>
                <a href="tel:0985410836" className="text-white font-bold text-xl hover:text-[#c81f1a] transition-colors">
                  0985 410 836
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-[#1a5c35]/40 border border-[#256b40]/40 rounded-xl p-4">
              ...
              <div>
                ...
                <a href="https://zalo.me/0985410836" className="text-white font-bold text-xl hover:text-[#0068ff] transition-colors">
                  0985 410 836
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-[#1a5c35]/40 border border-[#256b40]/40 rounded-xl p-4">
              ...
              <div>
                ...
                <div className="text-white font-medium text-sm">Toàn quốc – Hỗ trợ online & tại nhà</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl">
          {sent ? (
            <div className="flex flex-col items-center justify-center py-8 text-center">
              <div className="w-16 h-16 bg-[#1a5c35] rounded-full flex items-center justify-center text-white text-3xl mb-4">✓</div>
              <h3 className="text-[#0d3320] font-black text-xl mb-2">Đăng ký thành công!</h3>
              <p className="text-gray-500 text-sm">Chuyên viên sẽ liên hệ lại trong vòng 30 phút. Cảm ơn bạn đã tin tưởng Tín Chấp Việt!</p>
              <button onClick={() => setSent(false)} className="mt-6 text-[#1a5c35] text-sm font-semibold underline">
                Gửi yêu cầu khác
              </button>
            </div>
          ) : (
            <>
              <h3 className="font-black text-[#0d3320] text-xl mb-1">Đăng Ký Vay Vốn</h3>
              <p className="text-gray-400 text-sm mb-6">Điền thông tin – Chuyên viên sẽ liên hệ ngay</p>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[#0d3320] font-semibold text-sm mb-1.5">Họ và tên *</label>
                  <input
                    required
                    value={form.name}
                ...
                <div>
                  <label className="block text-[#0d3320] font-semibold text-sm mb-1.5">Số điện thoại *</label>
                  <input
                    required
                    type="tel"
                    value={form.phone}
                ...
                <div>
                  <label className="block text-[#0d3320] font-semibold text-sm mb-1.5">Số tiền cần vay</label>
                  <select
                    value={form.amount}
                ...
                <div>
                  <label className="block text-[#0d3320] font-semibold text-sm mb-1.5">Ghi chú</label>
                  <textarea
                    value={form.note}
                ...
                <p className="text-center text-gray-400 text-xs">Thông tin của bạn được bảo mật tuyệt đối</p>
              </form>
            </>
          )}
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-white flex items-center justify-center overflow-hidden shrink-0">
            <img src={logoImg} alt="Tín Chấp Việt" className="w-8 h-8 object-contain" />
          </div>
          <span className="text-[#a8d5b5] text-sm font-semibold">TÍN CHẤP VIỆT</span>
        </div>
        <p className="text-[#4a7a5a] text-xs text-center">
          © 2024 Tín Chấp Việt. Hotline: 0985 410 836 · Zalo: 0985 410 836
        </p>
        <div className="flex items-center gap-3">
          <a href="tel:0985410836" className="w-8 h-8 rounded-full bg-[#1a5c35] flex items-center justify-center text-white hover:bg-[#256b40] transition-colors">
            <PhoneIcon />
          </a>
          <a href="https://zalo.me/0985410836" className="w-8 h-8 rounded-full bg-[#0068ff] flex items-center justify-center text-white text-xs font-black hover:bg-[#0052cc] transition-colors">
            Za
          </a>
        </div>
      </div>
